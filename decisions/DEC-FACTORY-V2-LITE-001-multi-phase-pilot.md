...
The first 3 bugs are pre-existing issues in the factory's CLI worker layer that v2-lite's pilot exposed. BUG-FAC-006 is a post-fix compatibility finding from a clean Windows scratch run after FAC-001..005 landed.
