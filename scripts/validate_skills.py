"""Validate skill records (SKILL.md) in procurement-negotiation-lab.
...
# Env-var override mirrors the validate_decisions.py pattern in sibling
# repos so the offline-cache code path stays testable end-to-end.
...
def load_remote_schema() -> dict[str, Any] | None:
    try:
        req = urllib.request.Request(  # noqa: S310
            REMOTE_URL,
            headers={"User-Agent": "procurement-lab/validate_skills"},
        )
