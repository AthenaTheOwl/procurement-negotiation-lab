...
import type { AlgorithmResult, ArcStep, LabScenario } from "@lab/engine";
import { algorithmResults, arcSteps, compileFormula, effectiveCapacity, frontier, informationSweep, labTakeaway, makeScenario, runDecoyAudit, scenarioPresets, transferLedger } from "@lab/engine";
