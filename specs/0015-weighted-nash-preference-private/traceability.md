...
| **R-NASH-007** multi-party generalization (owner_role: engineering.implementation) | C1, C2, C3 | Solver accepts N=2..10; no NotImplementedError at N>2; SDK demo + property battery cover N=3,5 | planned |
