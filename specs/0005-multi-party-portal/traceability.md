...
| **R-PORTAL-004** strategy library | C1, C2, C3, C4, C5 | Pass C: ≥ 8 strategies; all roles covered; each parses; one-click instantiation; doc exists | done (10 strategies + ParticipantBuilder one-click add/remove) |
| **R-PORTAL-005** scenario schema + versioning | D1, D2, D3, D4, D5, D6 | Pass D: zod schema; schemaVersion; migration; round-trip lossless; field-path errors; doc exists | done (scenarioSchema.ts + scenarioMigrate.ts + ScenarioImportExportPanel paste/copy round-trip) |
