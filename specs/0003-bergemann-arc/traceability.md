...
| **R-ARC-004** authored utility formulas | C1, C2, C3, C4, B9 | Pass C: formula engine accepts/rejects per whitelist; ≥ 90 % coverage. Pass B step 6: editor reruns sim on valid formula, shows error on invalid | in progress (engine done; B9 pending) |
