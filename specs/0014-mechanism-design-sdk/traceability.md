...
| **R-SDK-004** mechanism sensitivity is reported across a deterministic stress grid (owner_role: science.proof-gate-runner) | A6, A7, V3 | `tests/test_sensitivity.py`; canonical JSONL and Markdown reports; first action and unhappy-path checks | done |
