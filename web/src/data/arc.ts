...
export const arcSteps: ArcStep[] = [
  ...
  },
  {
    ...
    thesis:
      "More information usually improves the plan, but it also exposes bargaining posture. The design question is not full transparency; it is enough signal for coordination.",
